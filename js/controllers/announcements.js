	...
	$scope.data.announcements = [
		{
			...
			+ '<p>The website now uses Google federated login. Any account used on Gmail, Google Docs, YouTube, etc. will work. If you don\'t have a Google account, you can create one <a href="https://accounts.google.com/SignUp">here</a>.'
			+ '<p>If you have any questions about this transition, please contact us at <a href="mailto:zerorobotics@mit.edu">zerorobotics@mit.edu</a>.' 
		}
	];
