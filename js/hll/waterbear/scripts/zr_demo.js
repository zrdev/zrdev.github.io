...
window.choice_lists = {
    ...
    variables: ['x','y','z','vx','vy','vz','eggs','spam']
};
...
var menus = {
    control: menu('Control', [
        {
	    label: 'assign [choice:variables] = [number:0]',
	    script: '{{1}} = {{2}};'
	},
        {
        ...
        {
	    label: 'if [boolean] then else',
	    containers: 1,
	    script: 'if ({{1}}) { [[2]] } else { [[3]] }'
	},
        {
	    label: 'DEBUG',
	    script: 'DEBUG();'
        ...
        {
	    label: 'foreach [choice:variables] ',
	    containers: 1,
	    script: 'for (var index in {{1}}) { [[1]] }'
	},
        {
	    label: 'forrange [number:0] [number:0] ',
	    containers: 1,
	    script: 'for (var index = {{1}}; index <= {{2}}; index++) { [[1]] }'
	},
        {
        ...
        {
            label: 'when [choice:variables] key pressed', 
            trigger: true, 
    ...
    sensing: menu('Sensing', [
        ...
        {
            label: 'key [choice:variables] pressed?', 
            'type': 'boolean', 
            script: '$(document).bind("keydown", {{1}}, function(){\n[[1]]\n});'
        },
        {
    ...
    transform: menu('Transform', [
        {
	    label: 'Set Velocity [choice:variables]'
        },
        {
            label: 'clear canvas', 
